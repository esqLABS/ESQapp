...
Scenarios with duplicate names are highlighted in red, as each  
...
-   To edit the **simulation time** of a scenario, double-click on the  
    ...
    ![simulation time edit](Figures/getting-started/fig5.png)  
...
-   **Parameter sets** are defined in the `Parameter sets` column.  
    ...
    ![parameter sets column](Figures/getting-started/fig17.png) 

-   The applications is specified for a scenario in the column
    `ApplicationProtocol`, which shows a drop-down list with all applications
    defined in the **Applications** tab. To unassign a application protocol from a
    scenario: 
      - Right-click on the cell and select **Clear**, 
      - Press the **Backspace** key on your keyboard, or
      - Select `--NONE--` option in the drop-down list.
...
![adding-individual-sheet](Figures/getting-started/fig8.png)
![select-individual-sheet](Figures/getting-started/fig9.png)
