...
This outlines how to propose a change to ESQapp. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("esqLABS/ESQapp", fork = TRUE)`.
...
of Conduct](https://esqlabs.github.io/ESQapp/CODE_OF_CONDUCT.md). By
