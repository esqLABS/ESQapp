...
Thanks for using ESQapp! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/esqLABS/ESQapp/issues/new).
...
requests](https://github.com/esqLABS/ESQapp/issues) to make sure the bug
